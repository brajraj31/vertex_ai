...
import warnings
import get_input_data, feature_engineering, model_scoring, publish_msg_pbsb
...
def pipeline(
    ...
    publish_msg_pbsb_op = components.create_component_from_func(publish_msg_pbsb.publish_msg_pbsb,
                                                 base_image=BASE_IMAGE,
                                                 packages_to_install=['google-cloud-bigquery[pandas]==2.34.3','pandas',
    ...
    model_scored = model_scoring_op(feature_data.output, big_query_op)
    publish_msg_pbsb_op(model_scored.output, project_id, "credit")
